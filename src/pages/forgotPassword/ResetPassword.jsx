...
const ResetPassword = () => {
  ...
  return (
    <>
      <main className=" animate__animated animate__fadeIn" style={{ fontFamily: "'Poppins', sans-serif" }}>
        <div className=" w-100 d-flex flex-column flex-lg-row" style={{ height: "100vh" }}>
          <div className=" w-100 w-lg-50 p-3 p-sm-5 ">
            <main>
              <main className=" m-auto ">
                ...
                <h5 className="ms-sm-4 text-center text-sm-start pb-4 fs-1">Forgot password?</h5>
                <form
                  onSubmit={verify}
                  className="ms-sm-4"
                >
                  <p className="pe-5 text-dark">Enter the email address associated with your account.</p>
