    ...
    <>
      ...
      >
        <main
          ...
          style={{ fontFamily: "'Poppins', sans-serif", width: "400px" }}
        >
          <div
            className="d-flex align-items-center text-white justify-content-center mx-auto my-3 bg-success fs-5"
            style={{
              border: "8px solid rgba(151, 179, 97, 0.741)",
              borderRadius: "28px",
              width: "48px",
              height: "48px",
            }}
          ...
          <div className="text-dark  my-5" style={{ fontSize: "17px" }}>
            {" "}
